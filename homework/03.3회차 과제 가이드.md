...
- 아래 측면에서 스킬을 개선하세요.     
- 실용성을 높이기 위해 **실제 업무에 적용하고 개선하는 개선 Loop를 반복** 하세요.     
  ```
  - 구체성 개선
    - 구체적인 숫자 또는 기준이 적합한가 ?  
  - 업무 배분 개선
  ...
  ```
- **평가 시 대화창 갯수 반영**  
  얼마나 많은 대화창을 사용했는지 평가 시 중요하게 반영합니다.     
  ![](images/2026-07-21-18-06-38.png)    
...
- Google Docs 접근: [3회차 과제 제출 문서](https://docs.google.com/document/d/1iDGGnhdI2_u4he1FG1Ztasp8WvCmRPXNbgJh3u4zjUQ/edit?usp=sharing)
