...
- 스킬을 호출하여 MCP 서버 연동이 계획한대로 동작하는지 테스트 
...
- Google Docs 접근: [4회차 과제 제출 문서](https://docs.google.com/spreadsheets/d/1-6wA37-tczQsszM_US3ve-L5cHbFSPPu/edit?usp=drive_link&ouid=110516422607493163049&rtpof=true&sd=true)
...
## 평가 기준     
- MCP서버 비즈니스 가치: 업무에 실질적인 도움을 주어 효율성/편의성을 증대 시키는가?  
